import { SavedPayment } from '../pages/AccountPage';

export const savedPayments: SavedPayment[] = [
...
{ nickname: 'My Paypal', type: 'paypal', email: 'name@example.com', isDefault: true },
  { nickname: 'My Commbank Account', type: 'directDebit', bsb: 123456, accName: 'John Smith', accNumber: 123456789012 }
]