import {
    ...
    Accordion,
    AccordionItem,
    AccordionButton, AccordionIcon, AccordionPanel, Switch, Modal, ModalOverlay, Spinner
...
import {Airline, Flight, SavedPayment} from "../models";
...
export const HolidayPackageBookingPage = () => {
    ...
    useEffect(() => {
        setBookingRequest({
            ...bookingRequest,
            flightIds: holidayPackage?.flights.map(value => value.id),
    ...
    useEffect(() => {
        ...
        httpGetHolidayPackages('/2').then(setHolidayPackage);
    }, []);
    ...
    const updateBookingInfo = () => {
        setBookingRequest({...bookingRequest, ['holidayPackageId']: holidayPackage?.id})
        ...
        for (var i = 0; i < passengerCount; i++) {
            ...
            setBookingRequest({...bookingRequest, passengers: [...bookingRequest.passengers, passengersList[i]]})
            console.log(passengersList[i]);
            console.log(bookingRequest.passengers);
        }
    }
            ...
            <Flex justifyContent='center' direction='column' w='50em'>
                <Center>
                    <Box>
                        ...
                        <div>{bookingRequest.passengers.map((entry: Passenger | undefined) =>
                ...
                {renderPassengerForms()}
                    ...
                    <form>
                        ...
                        <HStack w='full' gap='1em' mt='2em'>
                            ...
                            <Button onClick={updateBookingInfo} colorScheme='red'>
                                Update Info
                            </Button>
                        </HStack>
                    </form>
